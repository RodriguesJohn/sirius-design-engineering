...
Deskly is the helpdesk Ritual Goods already runs. Start it from the repo root with
`python3 helpdesk/deskly.py` (no dependencies). Base URL: `http://localhost:8099/api/v2`.
CORS is open — call it straight from browser JS. State is in-memory; restarting gives
you a clean slate.
